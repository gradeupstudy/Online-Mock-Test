...
export const INDIAN_STATES_AND_DISTRICTS: StateData[] = [
  ...
  },
  {
    state: "Chhattisgarh",
    districts: [
      "Balod", "Baloda Bazar", "Balrampur", "Bestar", "Bemetara", "Bijapur", "Bilaspur",
  ...
  },
  {
    state: "Telangana",
    districts: [
      "Adilabad", "Bhadradri Kothagudem", "Hyderabad", "Jtial", "Jangaon", "Jayashankar Bhupalpally",
...
export const INDIAN_STATES_DISTRICTS: Record<string, string[]> = INDIAN_STATES_AND_DISTRICTS.reduce((acc, curr) => {
